...
class Router:
    ...
    def add_route(
        self, name: str, method: str, path: str, handler: RouteHandlerT
    ) -> None:
...
class Application:
    ...
    def add_route(
        self, method: str, path: str, handler: RouteHandlerT, name: Optional[str] = None
    ) -> None:
        self.router.add_route(name or handler.__name__, method, path, handler)

    def route(
        self, path: str, method: str = "GET", name: Optional[str] = None
